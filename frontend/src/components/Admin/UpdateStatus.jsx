...
const UpdateStatus = ({ flightId, onClose, onSuccess }) => {
      ...
      useEffect(() => {
        if (flightId) {
          const fetchFlightData = async () => {
            try {
              const response = await axios.get(`${server}/flight/flights/${flightId}`);
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          if (flightId) {
            await axios.put(`${server}/flight/flights/${flightId}`, {
              flightNumber,
              departure,
              arrival,
              date,
